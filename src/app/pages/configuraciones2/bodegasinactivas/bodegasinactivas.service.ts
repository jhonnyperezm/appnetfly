...
export class BodegasinactivasService {
  ...
  getPuntoBodegas() {
    const response = this.http.get(this.path + this.baseUrlPuntoBodega + 'findPuntoBodega/false', this.options).pipe(map(res => res.json()));
    return response;
  }
  putActivar(id) {
