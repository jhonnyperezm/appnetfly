...
export class ImportarlistapreciosService {
  ...
  postImportar(DataList) {
    const response = this.http.post(this.path + this.baseUrlImportarListasPrecios + 'importarListaPrecios', DataList, this.options);
    return response;
  }
}
